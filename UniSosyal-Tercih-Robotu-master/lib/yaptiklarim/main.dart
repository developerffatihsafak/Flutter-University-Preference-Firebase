...
class Yaptiklarim extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Bugun Ne Yaptın',
      theme: ThemeData(
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Bugun Kaç Soru Çözdüm'),
      ),
      body: ListView(
        children: <Widget>[
          Form(
            ...
            child: Padding(
              ...
              child: Column(
                children: <Widget>[
                  TextFormField(
                    decoration: new InputDecoration(labelText: 'Ders Adı'),
                    controller: _nameController,
                    validator: (val) =>
                        val.isNotEmpty ? null : 'Ders Alanı boş geçilemez',
                  ),
                  TextFormField(
                    decoration: new InputDecoration(labelText: 'Kaç Soru Çözdün'),
                    controller: _courseController,
                    validator: (val) =>
                        val.isNotEmpty ? null : 'Kaç Soru Çözdün Alanı boş geçilemez',
                  ),
                               ...
                               children: <Widget>[
                                 Container(
                                   ...
                                   child: Column(
                                     ...
                                     children: <Widget>[
                                       Text('Ders Adı: ${st.name}',style: TextStyle(fontSize: 20),),
                                       Text('Soru Sayısı: ${st.course}', style: TextStyle(fontSize: 15, color: Colors.black54),),
